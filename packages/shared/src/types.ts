...
export type Crop = InferSelectModel<typeof s.crops>;
...
export type Khata = InferSelectModel<typeof s.khatas>;
export type KhataPartner = InferSelectModel<typeof s.khataPartners>;
export type InventoryEntry = InferSelectModel<typeof s.inventoryEntries>;
...
export type NewCrop = InferInsertModel<typeof s.crops>;
...
export type NewKhata = InferInsertModel<typeof s.khatas>;
export type NewKhataPartner = InferInsertModel<typeof s.khataPartners>;
export type NewInventoryEntry = InferInsertModel<typeof s.inventoryEntries>;
...
export type KhataStatus = 'open' | 'settled';
